...
```
When BAM file is available, we need to sort and index it (to have the .bam.bai index)
```
samtools sort CCARE_SA_075No_S17.bam -o CCARE_SA_075No_S17_sorted.bam | samtools index *_sorted.bam
```
